...
image::running_vma_tool_analysis/rvtools.png[title="", link=self, window=blank, width=100%]
...
+
. Download RVTools
.. Visit https://downloads.dell.com/rvtools/rvtools4.7.1.msi?hve=Download+RVTools[RVTools Download] and download the RVTools MSI package.
+
. Install RVTools
.. Double-click the MSI package and follow the installation prompts.
+
image::running_vma_tool_analysis/install.png[title="", link=self, window=blank, width=100%]
+
. Launch RVTools
...
+
image::running_vma_tool_analysis/running_rvtools.png[title="", link=self, window=blank, width=100%]
...
+
image::running_vma_tool_analysis/vinfo.png[title="", link=self, window=blank, width=100%]
+
...
+
image::running_vma_tool_analysis/menus.png[title="", link=self, window=blank, width=100%]
+
...
+
image::running_vma_tool_analysis/documentation.png[title="", link=self, window=blank, width=100%]
+
. Exporting Data
.. Select "File" then "Export all to Excel"
+
image::running_vma_tool_analysis/export.png[title="", link=self, window=blank, width=100%]
+
.. or using CLI +
...
* link:https://github.com/rhpds/etx-virt-vma-factory-showroom/raw/refs/heads/main/vma-rvtools-analysis/example_rvtools_files/dallas.xlsx[Dallas Primary]
* link:https://github.com/rhpds/etx-virt-vma-factory-showroom/raw/refs/heads/main/vma-rvtools-analysis/example_rvtools_files/dallas1.xlsx[Dallas Secondary]
* link:https://github.com/rhpds/etx-virt-vma-factory-showroom/raw/refs/heads/main/vma-rvtools-analysis/example_rvtools_files/houston.xlsx[Houston]
* link:https://github.com/rhpds/etx-virt-vma-factory-showroom/raw/refs/heads/main/vma-rvtools-analysis/example_rvtools_files/ashburn.xlsx[Ashburn]
...
If you are a Red Hatter, please check the latest version of the tool in the following internal Git repository: https://github.com/rhpds/vma-virt-analysis[Git VMA RVTools Analysis].
====
...
[source, shell]
----
git clone https://github.com/rhpds/etx-virt-vma-factory-showroom.git
----
+
...
+
image::running_vma_tool_analysis/index_template_spreadsheet.png[title="", link=self, window=blank, width=100%]
+
...
+
image::running_vma_tool_analysis/rvtools-exported-worksheets.png[title="", link=self, window=blank, width=100%]
+
...
====
+
image::running_vma_tool_analysis/jupyter-notebook.png[title="", link=self, window=blank, width=100%]
+
. Select the Notebook
...
+
image::running_vma_tool_analysis/run-the-jupyter-notebook.png[title="", link=self, window=blank, width=100%]
...
+
image::running_vma_tool_analysis/data_ingestion.png[title="", link=self, window=blank, width=100%]
+
. Distribution of VMs per vCenter
+
image::running_vma_tool_analysis/vm_per_vcenter.png[title="", link=self, window=blank, width=100%]
+
. Insights on resource utilization (for AEs love this info)
+
image::running_vma_tool_analysis/consolidated_view.png[title="", link=self, window=blank, width=100%]
+
. VM / Host Scope Summary
+
image::running_vma_tool_analysis/scope_summary.png[title="", link=self, window=blank, width=100%]
+
. Host Model Summary
+
image::running_vma_tool_analysis/host_model.png[title="", link=self, window=blank, width=100%]
+
. Disk Usage Summary
+
image::running_vma_tool_analysis/disk_summary.png[title="", link=self, window=blank, width=100%]
+
. Supported vs NonSupported OSes
+
. Estimated Migration Time
+
image::running_vma_tool_analysis/migration.png[title="", link=self, window=blank, width=100%]
+
. and much, much more...

Please explore the notebook and its outputs to gain a deeper understanding of the vSphere environment and contribute to the tool if possible.
