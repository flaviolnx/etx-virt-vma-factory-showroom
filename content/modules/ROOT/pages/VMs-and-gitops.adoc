...
The course git repo is located at `https://github.com/rhpds/etx-virt-vma-factory-showroom`.
...
[source,console,subs="attributes"]
----
$ export gitops_repo=https://github.com/rhpds/etx-virt-vma-factory-showroom.git
