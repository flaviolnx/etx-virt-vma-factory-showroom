...
+
. login into your gitea https://gitea.apps.{openshift_cluster_ingress_domain}
+
...
git remote add origin https://gitea.apps.{openshift_cluster_ingress_domain}/<YOUR GIT USER>/openshift_vi
