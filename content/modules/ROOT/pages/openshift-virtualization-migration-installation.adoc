...
image::Ansible-Migration-Install/vmware-inventory.png[link=self, window=blank, width=100%]
...
image::Ansible-Migration-Install/create-vm.png[link=self, window=blank, width=100%]

Select the your folder: {vcenter_vm_folder}, name the vm to *rhel9-to-be-migrated-1* and click next.

image::Ansible-Migration-Install/vm-folder-select.png[link=self, window=blank, width=100%]

Select one of three hosts, see the compatibility check in green and click next.

image::Ansible-Migration-Install/vm-esxi.png[link=self, window=blank, width=100%]

Select one of DataStore locations, see the compatibility check in green and click next.

image::Ansible-Migration-Install/vm-storage.png[link=self, window=blank, width=100%]

Mark the options *Customize this virtual machine's hardware* and *Power on virtual machine after creation* and click in next.

image::Ansible-Migration-Install/vm-options.png[link=self, window=blank, width=100%]

Go to add new device, add a Network card adapter and click next.

image::Ansible-Migration-Install/vm-new-device.png[link=self, window=blank, width=100%]
