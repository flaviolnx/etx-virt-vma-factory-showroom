...
[source,shell]
----
podman login quay.io/rhpds
----

[NOTE]
====
Use your given credentials to login into quay.io
====
...
[source,shell]
----
podman pull quay.io/rhpds/openshift-virtualization-migration-ee:latest
----

#### Method 2 

For network restriction reasons there is a tar image of the execution environment are residing into bastion lab-user home area, and you can use it locally:

[source,shell]
----
podman load -i openshift-virtualization-migration-ee:latest.tar
----
...
login into your gitea https://gitea.apps.cluster-{GUID}.dynamic.redhatworkshops.io 
...
git remote add origin https://gitea.apps.cluster-{GUID}.dynamic.redhatworkshops.io/user1/openshift_virtualization_migration.git
