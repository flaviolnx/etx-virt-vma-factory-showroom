...
tar xf infra-openshift_virtualization_migration-1.21.1.tar.gz
...
[TIP]
====
The *ETX Workshop Git Repository* is the repository located at link:https://github.com/rhpds/etx-virt-vma-factory-showroom[https://github.com/rhpds/etx-virt-vma-factory-showroom] which was cloned in the prior exercise relating to xref:VMs-and-gitops.adoc[GitOps and Virtual Machines].
====
...
----
cd /home/lab-user
git clone https://github.com/rhpds/etx-virt-vma-factory-showroom
